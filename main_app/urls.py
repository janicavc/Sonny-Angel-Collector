...
urlpatterns = [
    ...
    path('cats/<int:cat_id>/assoc_outfit/<int:outfit_id>/', views.assoc_outfit, name='assoc_outfit'),
    path('cats/<int:cat_id>/unassoc_outfit/<int:outfit_id>/', views.unassoc_outfit, name='unassoc_outfit'),
